...
public class LoadData {
    ...
    public HashMap<String, Integer> loadUnigram(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/tag1gram.txt"));
            String s = "";
    ...
    public HashMap<String, Integer> loadBigram(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/tag2gram.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                String[] tokens = s.split(" ");
    ...
    public HashMap<String, Integer> loadTrigram(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/tag3gram.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                String[] tokens = s.split(" ");
    ...
    public HashMap<String, Integer> loadOriginalEmission(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/originalEmission.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                String[] tokens = s.split(" ");
                if(tokens.length == 3){
    ...
    public HashMap<String, Integer> loadExtensionEmission(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/extensionEmission.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                String[] tokens = s.split(" ");
                if(tokens.length == 5){
    ...
    public HashMap<String, String> loadLexicon(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/lexicon.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                int pos = s.indexOf(" ");
    ...
    public HashMap<String, String> loadAbbreviation(){
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/standard.txt"));
            String s = "";
            while((s=br.readLine()) != null){
                String[] tokens = s.split("/");
    ...
    public HashMap<String, String> loadSyllable(){
        try{
            BufferedReader br = new BufferedReader(new FileReader("E:/ngramdict/SyllableLexicon.txt"));
            String s = "";
            while((s = br.readLine()) != null){
                int pos = s.indexOf(" ");
