...
//
////convert a word into its Telex keyboard list. "biÃªn" -> "bieen"
...
// Kiá»ƒm tra 1 Ã¢m tiáº¿t cÃ³ máº¯c pháº£i lá»—i Ã¢m cuá»‘i hay khÃ´ng
...
// Kiá»ƒm tra 1 Ã¢m tiáº¿t cÃ³ máº¯c pháº£i lá»—i Ã¢m Ä‘áº§u hay khÃ´ng
...
//// kiá»ƒm tra 2 xÃ¢u cÃ³ pháº£i lÃ  hoÃ¡n vá»‹ cá»§a nhau ko
...
//        System.out.println("total error: "+textFirst+" "+text+" "+textLast);
        /*if (regex_match(text,numbercheck) || text.find("Â°") != string::npos || text.find("%") != string::npos)
         return;
...
//                        System.out.println("add new local error 3: "+ t);
    ...
    String process(String lastword2, String lastword1, String curword, String nextword1, String nextword2) {
        ...
        if (curword.matches(StringConstant.numbercheck) || curword.contains("Â°") || curword.contains("%")) {
            return curword;
        }
        ...
        if (Utility.foreignTest(tmp_lastword1)) {
            ...
            if (!Utility.isFullCharacter(tmp_lastword1)) {
                //cout<<"not word"<<endl;
                if (tmp_lastword1.matches(StringConstant.numbercheck) || tmp_lastword1.contains("Â°") || tmp_lastword1.contains("%")) {
        ...
        if (Utility.foreignTest(tmp_lastword2)) {
            ...
            if (!Utility.isFullCharacter(tmp_lastword2)) {
                //cout<<"not word"<<endl;
                if (tmp_lastword2.matches(StringConstant.numbercheck) || tmp_lastword2.contains("Â°") || tmp_lastword2.contains("%")) {
        ...
        if (Utility.foreignTest(tmp_nextword1)) {
            ...
            if (!Utility.isFullCharacter(tmp_nextword1)) {
                //cout<<"not word"<<endl;
                if (tmp_nextword1.matches(StringConstant.numbercheck) || tmp_nextword1.contains("Â°") || tmp_nextword1.contains("%")) {
        ...
        if (Utility.foreignTest(tmp_nextword2)) {
            ...
            if (!Utility.isFullCharacter(tmp_nextword2)) {
                //cout<<"not word"<<endl;
                if (tmp_nextword2.matches(StringConstant.numbercheck) || tmp_nextword2.contains("Â°") || tmp_nextword2.contains("%")) {
...
//                    System.out.println("  temp_rate1, tu so: "+((double)getBigramFrequency(tmp_lastword1+" "+it_word,0,bigramDictionarySize-1)+smooth)+", mau so: "+(double)getUnigramFrequency(tmp_lastword1,0,6770));
            ...
            if ((error.get(i) != l) && ((it_word.equals("vÃ ") || it_word.equals("cá»§a") || it_word.equals("lÃ ") || it_word.equals("nÃ o")))) {
                temp_rate -= 3.5;
            }
...
//        System.out.println(tmp1 + " " + tmp2 + " " + tmp3);
    ...
    void processFile(String fileNameIn, String outputFileName) throws Exception {
        ...
        error_count = 0;
        s = null;
//        System.out.println(process("má»›i", "mua", "dung", "ma", "sao"));
        System.out.println(process("", "quyá»ƒn", "xÃ¡ch", "vÄƒn", "há»�c"));
...
//            s.useDelimiter(" |\\u2000|\\u2001|\\u2002|\\u2003|\\u2004|\\u2005|\\u2006|\\u2007|\\u2008|\\u2009|\\u200A|\\u200B|\\u2028|\\u2029|\\u3000|\\u00A0|\\uFEFF|\\n");
    ...
    /*String processSentence(String sentence) throws Exception {
        ...
        error_count = 0;
//        System.out.println(process("má»›i", "mua", "dung", "ma", "sao"));
//        System.out.println(process("mua", "dÃ¹ng", "ma", "sao", ""));
...
//sonnv.ict@gmail.com
    ...
    public static void main(String[] args) throws Exception {
        ...
        list = checker.Check("HÃ´m nay hÃ´m nay hÃ´m nay chá»�i dáº¥t Ä‘áº¹p Ä‘áº¹p");
        //System.out.println(list);
        for(int i=0;i<list.size();i++){
            list.get(i).getout();
        }
//           System.out.println(checker.processSentence("HÃ´m nay chá»�i dáº¥t Ä‘áº¹p"));
